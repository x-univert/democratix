    ...
    <footer className={styles.footer}>
        ...
        <div className={styles.footerLeft}>
          ...
          <div className={styles.footerSocials}>
            <FontAwesomeIcon
              ...
              onClick={() => handleSocialClick('https://twitter.com/democratix')}
            />
            <FontAwesomeIcon
              icon={faTelegram}
              className={styles.footerSocialIcon}
              onClick={() => handleSocialClick('https://t.me/democratix')}
            />
            <FontAwesomeIcon
              icon={faFacebook}
              className={styles.footerSocialIcon}
              onClick={() => handleSocialClick('https://facebook.com/democratix')}
            />
            <FontAwesomeIcon
              icon={faLinkedin}
              className={styles.footerSocialIcon}
              onClick={() => handleSocialClick('https://linkedin.com/company/democratix')}
            />
          </div>

          <div className={styles.footerCopyright}>
            © {currentYear} Democratix. All rights reserved.
          </div>
        </div>
        ...
        <div className={styles.footerRight}>
          ...
          <div className={styles.footerResourcesList}>
            <span
              ...
              onClick={() => window.open('https://economics.democratix.com', '_blank')}
            >
              Economics
            </span>
            <span
              className={styles.footerLink}
              onClick={() => window.open('https://docs.democratix.com', '_blank')}
            >
              Documentation
            </span>
            <span
              className={styles.footerLink}
              onClick={() => window.open('https://agora.democratix.com', '_blank')}
            >
              Agora
            </span>
            <div
            ...
            <span
              className={styles.footerLink}
              onClick={() => window.open('https://terms.democratix.com', '_blank')}
            >
              Terms
            </span>
            <div
      ...
      <div className={styles.footerBottom}>
        ...
        <div className={styles.footerDescription}>
          ...
          <span>by the DEMOCRATIX team, {currentYear}</span>
        </div>
      </div>
    </footer>
  );
